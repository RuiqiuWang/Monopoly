...
.PHONY: all test cli engine tutorial_test command_test mine_test tool_room_test assets_test character_select_test map_test item_usage_test item_effect_test fortune_test gift_house_test help_query_test property_test e2e_test json_test clean

all: test_movement movement_cli character_select_cli tutorial_test command_test mine_test tool_room_test assets_test character_select_test map_test item_usage_test item_effect_test fortune_test gift_house_test help_query_test property_test game_engine
...
game_engine: game_engine.c command.c tutorial.c map.c movement.c tui.c mine.c tool_room.c assets.c player.c character_select.c input.c item_usage.c item_effect.c fortune.c gift_house.c help_query.c property.c
	$(CC) $(CPPFLAGS) $(CFLAGS) game_engine.c command.c tutorial.c map.c tui.c movement.c mine.c tool_room.c assets.c player.c character_select.c input.c item_usage.c item_effect.c fortune.c gift_house.c help_query.c property.c -o $@
...
fortune_test: fortune.c property.c map.c player.c tests/test_fortune.c include/fortune.h
	$(CC) $(CPPFLAGS) $(CFLAGS) fortune.c property.c map.c player.c tests/test_fortune.c -o $@
...
test: test_movement tutorial_test command_test mine_test tool_room_test assets_test character_select_test map_test item_usage_test item_effect_test fortune_test gift_house_test help_query_test property_test e2e_test
	./test_movement
	./tutorial_test
	./command_test
	./mine_test
